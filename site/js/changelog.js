const changelogData = [
    ...
    },
    {
        ...
        changes: [
            ...
            "Use the world's most advanced language models that can reason their way through problems.",
            "Added Auto-Credit Refill, Features for Server Owners",
            "Server owners can now set default models and personalities, restrict models and personalities, and automatically refill credits to their server.",
            "Bug Fixes, Improved Error Handling",
            "Most errors will not cause the bot to not respond, they will send an output that you can create a ticket about. We fixed VideoGen for non-subscribers, credit notifications for people with DMs off, and a pricing issue that may have over/undercharged for certain chat models."
        ]
    },
    {
        version: "v4.6",
...
function displayChangelog(page) {
    ...
    const entryHtml = `
        <div id="${versionId}" class="changelog-card fade-in">
            <h2>${entry.version}</h2>
            <ul>
